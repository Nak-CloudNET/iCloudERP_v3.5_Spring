...
class Companies_model extends CI_Model
{
    ...
    {
        $this->db->select("companies.id,(CASE WHEN (LENGTH(CONCAT(code,' - ', name, ' (', company, ')')) > 50) THEN CONCAT(LEFT (CONCAT(code,' - ', name, ' (', company, ')'), 50), '...') ELSE CONCAT(code,' - ', name, ' (', company, ')') END) as text", FALSE);
