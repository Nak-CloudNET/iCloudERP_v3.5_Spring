...
class Project_plan_model extends CI_Model
{
	...
	public function getAllProjectPlanItem($id){
		$this->db->select('products.id as id, products.type, project_plan_items.product_code as code, project_plan_items.product_name as name, project_plan_items.quantity as qty, products.quantity as quantity')
