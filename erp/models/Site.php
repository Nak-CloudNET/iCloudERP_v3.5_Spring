...
class Site extends CI_Model
{
	...
	public function calculateAVCost($product_id, $warehouse_id, $net_unit_price, $unit_price, $quantity, $product_name, $option_id, $item_quantity, $transaction_type, $transaction_id, $status,$expiry) {
	...
	*********/
	...
	public function editCalculateAVGCost2017($product_id, $shipping, $quantity, $price, $total_price, $cost, $item_discount, $order_discount, $variant_id, $purcahse_id){
		$pur_cost  			= $this->purchases_model->getPurcahseItemByPurchaseIDProductID($purcahse_id, $product_id);
    ...
    public function costing($items) 
	{
        ...
        foreach ($items as $item) {
            ...
            if ($pr->type == 'standard') {	
                ...
                if (isset($citems['p' . $item['product_id'] . 'o' . $item['option_id']])) {
					...
					$citems['p' . $item['product_id'] . 'o' . $item['option_id']]['quantity'] += $item['quantity'];
					$citems['p' . $item['product_id'] . 'o' . $item['option_id']]['quantity_balance'] += $item['quantity_balance'];
                } else {
        ...
        $cost = array();
		//$this->erp->print_arrays($citems, $item);
