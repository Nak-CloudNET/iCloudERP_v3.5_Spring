        ...
        <div class="text-center">
            ...
            <table class="table-condensed receipt no_border_btm" style="width:100%;">
                ...
                <?php
					...
					$sub_total=0;
					$total_quantity=0;
					$old_paid = $row->paid - $row->amount;
					$total_cur_paid += $row->amount;
					$grand_total += ($invs->grand_total - $row->paid) + $row->amount;
			...
			<table class="received" style="width:100%;margin-top: 5px;">
				...
				<tr>
					...
					<th style="border-right:2px solid #000;border-top:none; border-bottom:2px solid;border-left:none; text-align: right;" class="text-right">$<?= $this->erp->formatMoney($grand_total-$total_cur_paid); ?></th>
				</tr>
					<?php }?>
			</table>
