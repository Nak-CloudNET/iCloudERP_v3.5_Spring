...
class Sale_order_model extends CI_Model
{
    ...
    {
        $this->db->select('erp_products.`code`,erp_deliveries.*, erp_products.name as description, delivery_items.quantity_received as qty, erp_companies.name, erp_units.name as unit, delivery_items.category_name as brand, delivery_items.option_id, product_variants.name as variant, (erp_delivery_items.quantity_received * erp_product_variants.qty_unit) as variant_qty');
