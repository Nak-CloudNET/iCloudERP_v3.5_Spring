	...
	<div class="container" style="width: 821px;margin: 0 auto;">
		<div class="col-xs-12" style="width: 794px;">
			...
			<div id="footer" class="row" style="margin-top: 80px !important;">
				<div class="col-sm-3 col-xs-3">
						 <form>
						<div class="checkbox" style="margin-top:-60px; margin-lefe:-50px;">
						  <label><input type="checkbox" value="">Cash</label>
						</div>
						<div class="checkbox">
						  <label><input type="checkbox" value="">Credit</label>
						</div>
						<p>Promise Date:___________</p>
						<p>Delivery Date:___________</p>
					  </form>
					
				</div>
				<div class="col-sm-3 col-xs-3">
					<center>
						<p style="margin-top:-60px; margin-bottom:82px;font-weight:bold;">Prepare By(Rep)</P>
				...
				<div class="col-sm-3 col-xs-3">
					<center>
						<p style="margin-top:-60px;margin-bottom:65px;font-weight:bold;">Check By Suppervisor</P>
						<p style="font-weight:bold;">Date:____/_____/____</p>
					</center>
				</div>
				<div class="col-sm-3 col-xs-3">
					<center>
						<p style="margin-top:-60px;margin-bottom:65px;font-weight:bold;">Approv By Sale Manager</P>
						<p style="font-weight:bold;">Date:____/_____/____</p>
					</center>
				</div>
			</div>
