...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		<?php if(isset($combine_delivery) && $combine_delivery) { ?>
			localStorage.setItem('combine_delivery', '<?= $combine_delivery ?>');
		<?php }else { ?>
			localStorage.setItem('combine_delivery', 0);
		<?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php } ?>
					<div class="form-group" id="dvpiece" style="display:none;">
					...
					<div class="form-group" id="dvwpiece" style="display:none;">
                        <label for="wpiece" class="col-sm-4 control-label"><?= lang('unit_quantity') ?></label>
